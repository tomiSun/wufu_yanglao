...
export class PatientInfo extends Component {
  ...
  componentWillReceiveProps(nextProps, nextState) {
     ...
     * */
    if (
      nextProps.hospital !== nextState.hospital ||
        ...
        <tbody>
          ...
          <tr className="percent4">
            ...
            <td>
              ...
              <span className="bline">{patientList.sex}</span>
            </td>
            <td>
          ...
          {/* <tr className="percent4">
            ...
            <td>
              <span className="btitle">病案号：</span>
              <span className="bline">{patientList.medicalHao}</span>
            </td>
            <td>
              <span className="btitle">入院日期：</span>
              <span className="bline">{patientList.admissionDateTime}</span>
            </td>
          </tr> */}
        </tbody>
      </table>
